...
export default function WhyUs() {
  ...
  <div className="whyus__test-rating-box">
    ...
    <div className="whyus__test-rating-content">
      <h4 className="whyus__test-rating-number">5.0</h4>
      <p className="whyus__test-overall-label">
    ...
    >
        ...
        {testimonials.map((t, i) => (
          <div className="whyus__test-card" key={i}>
            <div className="whyus__test-card-top">
              <div className="whyus__test-avatar">
                {t.name.charAt(0)}
              </div>
      ...
      {/* Fade edges */}
      <div
        className="whyus__test-fade-left"
        style={{ opacity: canScrollLeft ? 1 : 0 }}
      />

      <div
        className="whyus__test-fade-right"
