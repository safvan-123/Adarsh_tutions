...
const programList = [
  {
    ...
    badge: 'State & CBSE',
    tag: 'Class 11',
    title: 'Plus One Tuition',
    desc: 'Comprehensive tuition for Plus One covering all science subjects with daily practice and concept reinforcement.'
  },
  {
    id: 'p2',
    badge: 'State & CBSE',
    tag: 'Class 12',
    title: 'Plus Two Tuition',
    desc: 'Board-focused Plus Two tuition with rigorous text analytics, model exams, and daily evaluations.'
  },
  {
    id: 'p3',
    badge: 'CBSE',
    tag: 'Physics',
    title: 'CBSE Physics',
    desc: 'In-depth CBSE Physics tuition with conceptual clarity modules, numerical drills, and board pattern practice.'
  },
  {
    id: 'p4',
    badge: 'CBSE',
    ...
    desc: 'Structured CBSE Chemistry sessions covering organic, inorganic, and physical chemistry with NCERT focus.'
  },
  {
    id: 'p5',
    badge: 'CBSE',
    ...
    desc: 'Advanced CBSE Maths tuition with step-by-step problem solving, shortcuts, and board exam strategy.'
  },
  {
    id: 'p9',
    badge: 'State & CBSE',
    ...
    desc: 'Specialized Plus One Mathematics tuition covering Algebra, Trigonometry, Calculus, Statistics, and Coordinate Geometry with concept clarity, problem-solving practice, and exam-oriented preparation.'
  },
  {
    id: 'p6',
    badge: 'State Board',
    tag: 'Class 12',
    title: 'State Plus Two Tuition',
    desc: 'Kerala State Board Plus Two tuition aligned with state syllabus, textbook analysis, and public exam preparation.'
  },
  {
    id: 'p7',
    badge: 'Medical',
    tag: 'Competitive',
    title: 'NEET Coaching',
    desc: 'NCERT-centric daily practice sheets with performance analytics and full-length mock test series for NEET.'
  },
  {
    id: 'p8',
    ...
    tag: 'Competitive',
    title: 'CUET Coaching',
    desc: 'Domain-specific and general test preparation for CUET with subject modules, mock tests, and score boosters.'
  }
];
